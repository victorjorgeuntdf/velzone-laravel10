            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail" class="text-body">Sweatshirt
                                    for Men (Pink)</a></h5>
            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail" class="text-body">Noise
            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail" class="text-body">350 ml
